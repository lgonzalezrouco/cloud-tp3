...
# --- Autoscaling Policy: Target Tracking (CPU-based) ---
# This automatically creates and manages CloudWatch alarms - no manual alarms needed!
resource "aws_appautoscaling_policy" "ecs_cpu_target_tracking" {
  name               = "${var.app_name}-ecs-cpu-target-tracking"
